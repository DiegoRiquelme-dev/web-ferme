<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BOOrdenCompra.aspx.cs" Inherits="Web.BOOrdenCompra" %>
    ...
    <nav class="navbar navbar-inverse sidebar" role="navigation">
     ...
     <div class="container">
         <div class="row">
             ...
             <div class="col">
                 <h2>Administrar Orden de Compra </h2>
                 <form>
                     
                     <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Seleccionar Proveedor</label>
                     <select class="custom-select my-1 mr-sm-2" id="1">
                         <option selected>Elegir proveedor...</option>
                         <option value="1">Ceresita</option>
                         <option value="2">Tricolor</option>
                         <option value="3">Maquita</option>
                     </select>
                     <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Seleccionar Producto</label>
                     <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref">
                         <option selected>Elegir producto</option>
                         <option value="1">Pintura</option>
                         <option value="2">Clavos</option>
                         <option value="3">Destornillador</option>
                     </select>
                     <div class="form-group">
                         <label for="formGroupExampleInput">Cantidad de Productos</label>
                         <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Ingrese un numero entero">
                     </div>
                     <br />
                 </form>
                 <button class="btn btn-primary" style="margin-top: 25px; margin-left: 500px">Generar orden de compra</button>
             </div>
             <div class="col">
             </div>
         </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary">Recepcionar</button></td>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-xl-12">
                ...
                <div class="col-md-8 col-xs-8 col-xl-8">

                    <label id="lblproveedor">
                        Seleccione Proveedor
                    </label>
                    <asp:DropDownList ID="drpproveedor" runat="server">
                        <asp:ListItem>
                            Tricolor
                        </asp:ListItem>
                    </asp:DropDownList>
