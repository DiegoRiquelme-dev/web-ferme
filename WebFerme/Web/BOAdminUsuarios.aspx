<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BOAdminUsuarios.aspx.cs" Inherits="Web.BOAdminUsuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <h1 style="padding-left: 350px">Administrar usuarios</h1>
            <div class="container">
                <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <div class="form-group label-floating">
                        <asp:GridView runat="server" ID="gridUsuarios" >
                            <Columns>
